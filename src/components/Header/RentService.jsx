import { Car, Sgn } from '../../assets/images';
      ...
      <div className="flex flex-col items-center justify-between gap-x-10 lg:flex-row">
        <div className="w-full lg:w-2/5">
          ...
          <p className="modal-second-title text-secondary-text dark:text-white/50">
            Are you prepared to discover Ukraine in an entirely new way? Bid
            farewell to the constraints of public transportation and welcome the
            liberty of the open road with our exceptional car rental services!
            At <span className="text-accent-color">RentCars</span>, we are
            committed to ensuring your travel experiences are truly memorable.
          </p>
          <img src={Sgn} alt="signin" className="drop-shadow-2xl" width="100" />
        </div>
